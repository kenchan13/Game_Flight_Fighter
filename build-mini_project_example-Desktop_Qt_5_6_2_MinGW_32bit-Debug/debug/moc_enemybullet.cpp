...
#include "../../group_29/enemybullet.h"
...
const QMetaObject enemybullet::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_enemybullet.data,
      qt_meta_data_enemybullet,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *enemybullet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_enemybullet.stringdata0))
        return static_cast<void*>(const_cast< enemybullet*>(this));
